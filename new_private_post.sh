...
DIR="private_blog_posts"
mkdir -p "$DIR"

# 1) Ask for title
read -rp "Private post title: " TITLE
...
echo "Created private post: $FNAME"
echo "This post will be password-protected when you rebuild the site."
